...
TEST_PDF_FILEPATH: str = "/home/todd/python_projects/test_hoa_surpriseaz/output/pdf/StrengthLeadershipTest.pdf"
TEST_PDF_FILENAME: str = TEST_PDF_FILEPATH.split("/")[-1]
NEW_TEST_PDF_FILEPATH: str = (
    "/home/todd/python_projects/test_hoa_surpriseaz/output/pdf/Gallop.pdf"
)
